                      ...
                      <table>
                        ...
                        <tr>
                          <td style="background-color:red;"><div class="form-group">
                              <input type="radio" value="oui" name=""> <span>Rejet</span>
                          </div></td>
                          <td></td>
                          <td style="background-color:yellow;"><div class="form-group">
                              <input type="radio" value="" name=""> <span>Demande de modification</span>
                          </div></td>
                        </tr>
                      </table>
